    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.ZipCode", t => t.ZipCodeId, cascadeDelete: false)
                .Index(t => t.StateId)
                .Index(t => t.ZipCodeId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        InventoryItemCategoryId = c.Int(nullable: false, identity: true),
                        CategoryName = c.String(nullable: false),
                    })
                .PrimaryKey(t => t.InventoryItemCategoryId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        InventoryItemCategoryId = c.Int(nullable: false),
                ...
                .ForeignKey("dbo.InventoryItemCategory", t => t.InventoryItemCategoryId, cascadeDelete: false)
                .Index(t => t.InventoryItemCategoryId);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.InventoryItem", t => t.InventoryItemId, cascadeDelete: false)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.OrderStatus", t => t.StatusId, cascadeDelete: false)
                .Index(t => t.StatusId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.InventoryItem", "InventoryItemCategoryId", "dbo.InventoryItemCategory");
            ...
            DropIndex("dbo.InventoryItem", new[] { "InventoryItemCategoryId" });
